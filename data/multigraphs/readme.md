...
- colorability was checked with this [script](../../python/scripts/filter_uncol.py)

## Lists 

- [uncol_12_m2_all_small.txt](uncol_12_m2_all_small.txt) - List of all edge uncolorable multigraphs on 12 vertices
  - [high_conn_12_uncol_m.txt](high_conn_12_uncol_m.txt) - Those of them which have edge connectivity > 3, converted to simple graphs using [script](../../python/scripts/filter_low_con.py) (graph6 representation)
